<?php
	...
	<h1>Hello! Welcome to the tutorial!</h1>

	
	<ul>
		<li>
			<p><a href="http://www.webmonkey.com/2010/02/php_tutorial_for_beginners/">Take a look at this tutorial, it is an overview of what PHP is and what it can do</a></p>
		</li>
		<li>
			<p>Now let's make some things! Create a new file. For the steps below, just keep adding on to the file with each step, don't erase step 1 when you do step 2.</p>
		</li>
		<li>
